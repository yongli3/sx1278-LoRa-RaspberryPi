...
common.o: common.c
	gcc -g -c common.c -o common.o -lpigpio -lrt -pthread -lm -lmosquitto
...
lora: LoRa.o tx_explicit_example.o common.o
	gcc -g -o lora tx_explicit_example.o LoRa.o common.o -lpigpio -lrt -pthread -lm -lsqlite3 -lmosquitto
...
4gconnect: 4gconnect.o common.o
	gcc -O2 -o 4gconnect 4gconnect.o common.o -lrt -pthread -lm -lsqlite3 -lmosquitto -lusb
